...
public enum ModArmorMaterials implements ArmorMaterial {
    THORNSTEEL("thornsteel", 26, new int[]{5,7,5,4}, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 1f, 0f, () -> Ingredient.of(ModItems.THORNSTEEL_INGOT.get()));
    ...
    public String getName() {
        return ElementalRealms.MOD_ID + ":" + this.name;
    }
